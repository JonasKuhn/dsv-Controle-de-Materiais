...
<html lang="pt-br">
    ...
    <body>
        ...
        <!-- Form Name -->
    <legend>Empréstimo NTI</legend>

    <!-- Text input-->
    <div class="container-fluid">
        <div class="form group row">
            <label class="col-1 " for="idNome">Matrícula:</label>  
            <div class="col-md-5 ">
                <input id="idNome" name="idNome" type="text" placeholder="Número da Matrícula " class="form-control input-md" required="">
            </div>
        </div>
